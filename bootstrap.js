...
const hashSeaMonkey = "'sha256-xGA1ERFngZ6AZtytK91CwXQ9toYwTIK/4yo4HWqgXTQ='";
const pfBase = `typeof queueMicrotask !== 'function' && (queueMicrotask = function(f) {setTimeout(f, 0)});
...
(function(){
  if (Element.prototype.replaceChildren===undefined) {
    Element.prototype.replaceChildren = function(...nodesOrDOMStrings) {
      ...
      if (nodesOrDOMStrings.length) {this.append(...nodesOrDOMStrings)}
    }
  }
}());
  ...
  observe: function (subject, topic, data) {
    if ((topic == "http-on-examine-response" || topic == "http-on-examine-cached-response") &&
      ...
      try {
        ...
        } else if (subject.responseStatus != 304 &&
